...
for(let i =0; i < 16 ; i++){  
    ...
    rightDivs.setAttribute("style", "border:solid; height:25px; width:25px; margin: 0; padding:0");
    container.appendChild(rightDivs);  

    const topDivs = document.createElement("div");
    topDivs.setAttribute("style", "border:solid; height:25px; width:25px; margin: 0; padding:0");
    container.appendChild(topDivs);  

    const bottomDivs = document.createElement("div");
    bottomDivs.setAttribute("style", "border:solid; height:25px; width:25px; margin: 0; padding:0");
